  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-md-12.col-lg-7.mb-4.mb-md-0
            ...
            ul.lista-ul--color.mb-4
              li.ms-2
                ...
                p.m-0 Paquete final de indicadores y métricas para el plan estratégico de seguridad de las aplicaciones web.
              li.ms-2
                i.fas.fa-check-circle
                p.m-0 Objetivos del plan estratégico de seguridad en aplicaciones web.
              li.ms-2
                i.fas.fa-check-circle
        ...
        .row.justify-content-center.align-items-center.color4
          .col-md-12.col-lg-7.mb-4.mb-md-0
            ...
            ul.lista-ul--color.mb-4
              ...
              li.ms-2
                i.fas.fa-check-circle
                p.m-0 Definir un programa continuo de sensibilización y capacitación en seguridad de aplicaciones web, que facilite al equipo de TI la adopción del plan estratégico de manera eficaz.
              li.ms-2
                i.fas.fa-check-circle
                p.m-0 Establecer planes de acción y futuros proyectos para tratar de minimizar la brecha y pensar en llegar a un estado superior de nivel de verificación en seguridad de aplicaciones web.
              li.ms-2
                i.fas.fa-check-circle
        ...
        .row.justify-content-center.align-items-center.color4
          .col-md-12.col-lg-7.mb-4.mb-md-0
            ...
            ul.lista-ul--color.mb-4
              li.ms-2
                i.fas.fa-check-circle
                p.m-0 Hoja de ruta correspondiente al plan de acción para la implementación de la seguridad en aplicaciones web, en la cual se priorizan las iniciativas que se deben llevar a cabo para cerrar la brecha y alcanzar el estado deseado.
              li.ms-2
                i.fas.fa-check-circle
    ...
    .row.mb-4(data-aos="fade-right")
      .col-lg-3.col-xl-4.col-xxl-3
        .bg_2.p-2
          p.text-bold.m-0.ms-3 OWASP ZAP (<em>Zed Attack Proxy</em>)
    ...
    .row.justify-content-center.mb-4
      ...
      .col-lg-8(data-aos="fade-left")
        p ZAP es una herramienta de código abierto de fácil uso, flexible, extensible y gratuita mantenida por el esfuerzo conjunto del OWASP, que permite realizar pruebas de penetración para aplicaciones web. La aplicación actúa como un #[em proxy] ubicándose entre el navegador y el sistema a testear para la búsqueda de vulnerabilidades; con el fin de interceptar e inspeccionar los mensajes enviados entre estos dos y con la disponibilidad de realizar cambios en el contenido de este y reenviarlo al destino.
